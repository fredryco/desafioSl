...
public class PalavraRegras {
	...
	public String obterVogalValida(String palavra) {
		...
		return new StringBuffer().append("string: ").append(palavra).append(" </br>").append(" vogal:")
				.append(listaVogaisNRepetidas.get(listaVogaisNRepetidas.size()-1)).append(" </br> ")
				.append("tempoTotal: ")
